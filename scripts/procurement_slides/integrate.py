...
def why():
    ...
    advice = [
        ("① 繼續擴大，但目標放對", NAVY,
         "擴大結構化比對類工具的覆蓋；目標是把這 10–15% 的行政步驟做穩、降低 key-in 錯誤。"),
        ("② 這幾類建議維持現有人力", RED,
         "重大品質異常、議價協商（含匯率商談）、看色與核色判斷、跨廠催辦、跨國交涉 —— 這些環節的判斷與責任仍需由人承擔。"),
        ("③ 評估編制以量體為準", NAVY,
         "日後若要評估人力，建議以款數／PO 張數／異常件數等量體指標作為主要依據。"),
    ]
    y = 5.40
